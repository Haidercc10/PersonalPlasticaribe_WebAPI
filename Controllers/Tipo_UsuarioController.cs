...
namespace Personal_PlasticaribeWebAPI.Controllers
{
    ...
    public class Tipo_UsuarioController : ControllerBase
    {
        ...
        {
          if (_context.Tipos_Usuarios == null)
          {
              return NotFound();
          }
        ...
        public async Task<ActionResult<Tipo_Usuario>> PostTipo_Usuario(Tipo_Usuario tipo_Usuario)
        {
          if (_context.Tipos_Usuarios == null)
          {
              return Problem("Entity set 'DataContext.Tipos_Usuarios'  is null.");
          }
            _context.Tipos_Usuarios.Add(tipo_Usuario);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetTipo_Usuario", new { id = tipo_Usuario.TipoUsu_Id }, tipo_Usuario);
        }
        ...
        {
            return (_context.Tipos_Usuarios?.Any(e => e.TipoUsu_Id == id)).GetValueOrDefault();
        }
    }
}
